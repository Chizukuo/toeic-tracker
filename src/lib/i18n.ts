...
const copy: Record<Locale, Copy> = {
	zh: {
		...
		summaryMistakesHelper: '20 天计划内累计记录的错题总数',
		sprintProtocol: '训练规则',
		...
		analyticsTitle: '分析',
		mistakeTrend: '错题趋势',
		mistakeTrendDesc: '10 套听力与阅读的错题变化。',
		weaknessRadar: '短板雷达',
		...
		errorRate: '错误率',
		dataVaultTitle: '数据',
		dataVaultDescription: '导出、导入或重置本地数据。',
		exportTitle: '导出数据快照',
	...
	en: {
		...
		mistakeTrendDesc: 'Mistake change across the 10 listening and 10 reading sets.',
		...
		dataVaultTitle: 'Data',
		dataVaultDescription: 'Export, import, or reset local data.',
